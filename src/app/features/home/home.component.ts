  ...
  template: `
    ...
    <section class="relative overflow-hidden">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div class="max-w-3xl">
          <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/10 border border-accent/20 mb-6">
            <span class="w-2 h-2 rounded-full bg-accent animate-pulse"></span>
            <span class="text-xs font-medium text-accent">Tunisia's #1 Car Parts Marketplace</span>
          </div>

          <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-primary-50 tracking-tight leading-tight">
            Find the right parts
            <span class="text-accent"> for your vehicle</span>
          </h1>

          <p class="mt-6 text-lg text-primary-300 max-w-xl leading-relaxed">
